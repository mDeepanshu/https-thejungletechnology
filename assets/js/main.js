(function ($) {
	...
	$(function () {
		...
		document.getElementById('contact_form').addEventListener('submit', function (e) {
			...
			fetch('https://script.google.com/a/macros/thejungletechnology.com/s/AKfycbz-ficjDj2FI6Dv-L_3nBaQnTYg4hRTrBheH1xoSH7wZ4nHBk5zB-BZfADuZ45ellZF/exec', {
			method: 'POST',
			body: data,
			})
			...
			.then(result => {
				if (result.result === 'success') {
					...
					alert(result.message); // Show error message for duplicate email
					document.getElementById('contact_form').reset();
				  }
			})
			.catch(error => {
